...
for site in tmp.site.unique():
    ...
    for note in tmp2.reference.unique():
        plt.plot(
            tmp2.loc[tmp2.reference == note, "date"],
...
df_1 = df.loc[
    (df.site == "Summit") & (df.reference_short == "GC-Net"),
    ["date", "temperatureObserved"],
].set_index("date")
df_2 = df.loc[
    (df.site == "Summit") & (df.reference_short == "Giese and Hawley (2015)"),
    ["date", "temperatureObserved"],
].set_index("date")
df_merge = df_1 - df_2
print(
    "Summit", (df_1 - df_2).mean().values, np.sqrt(((df_1 - df_2) ** 2).mean().values)
)
...
ax.set_xlim(
    [
        (df_merge.loc[df_merge.temperatureObserved.notnull(), :].index.values[i])
        for i in [0, -1]
    ]
)
plt.legend()
...
df_1 = df.loc[
    (df.site == "CEN") & (df.reference_short == "PROMICE"),
    ["date", "temperatureObserved"],
].set_index("date")
df_2 = (
    df.loc[
        (df.reference_short == "Camp Century Climate"), ["date", "temperatureObserved"]
    ]
    .set_index("date")
    .resample("M")
    .first()
...
print(
    "Camp Century",
    (df_1 - df_2).mean().values,
    np.sqrt(((df_1 - df_2) ** 2).mean().values),
)
...
df_1 = df.loc[
    (df.site == "DYE-2") & (df.reference_short == "FirnCover"),
    ["date", "temperatureObserved"],
]
df_1.date = pd.to_datetime(df_1.date)
df_1 = df_1.set_index("date").resample("D").mean()
df_2 = df.loc[
    (df.site == "DYE-2") & (df.reference_short == "Covi et al."),
    ["date", "temperatureObserved"],
]
df_2.date = pd.to_datetime(df_2.date)
df_2 = df_2.set_index("date").resample("D").mean()
...
df_1 = df.loc[
    (df.site == "EKT") & (df.reference_short == "FirnCover"),
    ["date", "temperatureObserved"],
]
df_1.date = pd.to_datetime(df_1.date)
df_1 = df_1.set_index("date").resample("D").mean()
df_2 = df.loc[
    (df.site == "EKT") & (df.reference_short == "Covi et al."),
    ["date", "temperatureObserved"],
]
df_2.date = pd.to_datetime(df_2.date)
df_2 = df_2.set_index("date").resample("D").mean()
...
df_1 = df.loc[
    (df.site == "KAN_U") & (df.reference_short == "PROMICE"),
    ["date", "temperatureObserved"],
]
df_1.date = pd.to_datetime(df_1.date)
df_1 = df_1.set_index("date").resample("D").mean()
df_2 = df.loc[
    (df.site == "KAN-U") & (df.reference_short == "FirnCover"),
    ["date", "temperatureObserved"],
]
df_2.date = pd.to_datetime(df_2.date)
df_2 = df_2.set_index("date").resample("D").mean()
...
df_1 = df.loc[
    (df.site == "T-15a") & (df.reference_short == "Hills et al. (2018)"),
    ["date", "temperatureObserved"],
]
df_1.date = pd.to_datetime(df_1.date)
df_1 = df_1.set_index("date").resample("D").mean()
df_2 = df.loc[
    (df.site == "T-14") & (df.reference_short == "Hills et al. (2018)"),
    ["date", "temperatureObserved"],
]
df_2.date = pd.to_datetime(df_2.date)
df_2 = df_2.set_index("date").resample("D").mean()
...
df_1 = df.loc[
    (df.site == "T-15b") & (df.reference_short == "Hills et al. (2018)"),
    ["date", "temperatureObserved"],
]
df_1.date = pd.to_datetime(df_1.date)
df_1 = df_1.set_index("date").resample("D").mean()
...
df_1 = df.loc[
    (df.site == "T-15c") & (df.reference_short == "Hills et al. (2018)"),
    ["date", "temperatureObserved"],
]
df_1.date = pd.to_datetime(df_1.date)
df_1 = df_1.set_index("date").resample("D").mean()
...
df_1 = df_1.set_index("date").resample("D").mean()
df_2 = df.loc[
    (df.site == "T-16") & (df.reference_short == "Hills et al. (2018)"),
    ["date", "temperatureObserved"],
]
df_2.date = pd.to_datetime(df_2.date)
df_2 = df_2.set_index("date").resample("D").mean()
